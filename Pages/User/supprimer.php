<?php
    ...
    if (isset($_GET["idrec"])) {
        ...
        if ($res_sup_rec) {
            header("location:recette.php?result=succes_sup");
        }
    }
    ...
    if (isset($_GET["idfr"])) {
        ...
        if ($res_sup_fr) {
            header("location:fournisseur.php?result=succes_sup");
        }
    }
    ...
    if (isset($_GET["idch"])) {
        ...
        if ($res_sup_ch) {
            header("location:charge.php?result=succes_sup");
        }
    }
    ...
    if (isset($_GET["iddep"])) {
        ...
        if ($res_sup_dep) {
            header("location:depense.php?result=succes_sup");
        }
    }
    ...
    if (isset($_GET["idach"])) {
        ...
        if ($res_sup_ch) {
            header("location:achat.php?result=succes_sup");
        }
    }
    ...
    if (isset($_GET["idrist"])) {
        ...
        if ($res_sup_rist) {
            header("location:ristourne.php?result=succes_sup");
        }
    }
    ...
    if (isset($_GET["idutil"])) {
        ...
        if ($res_sup_util) {
            header("location:utilisateur.php?result=succes_sup");
        }
    }
